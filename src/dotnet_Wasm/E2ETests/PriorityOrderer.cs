...
// This attribute allows setting test execution order
...
// Custom test case orderer that uses the priority attribute
public class PriorityOrderer : ITestCaseOrderer
{
        ...
        where TTestCase : ITestCase
    {
        ...
        {
            list.Sort((x, y) => string.Compare(x.TestMethod.Method.Name, y.TestMethod.Method.Name, StringComparison.Ordinal));
