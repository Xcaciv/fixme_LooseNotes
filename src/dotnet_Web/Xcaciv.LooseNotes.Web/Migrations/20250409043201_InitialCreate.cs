    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "LastLogin", "Password", "ResetToken", "Role", "Username" },
                values: new object[,]
                {
                    { 1, "admin@example.com", null, "admin123", "admintoken123", "admin", "admin" },
                    { 2, "user@example.com", null, "password", "usertoken456", "user", "user" }
                });
